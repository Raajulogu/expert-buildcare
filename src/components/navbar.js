      ...
      {open && (
        <div className="w-[100vw] h-[100vh] bg-[#0E1031] flex flex-col items-center pt-[24px]">
         ...
         <div className="inline-flex flex-col items-start gap-[17px] text-[white]">
            <p className="font-inter text-[24px] font-bold cursor-pointer">Home</p>
            <p className="font-inter text-[24px] font-bold cursor-pointer">About US</p>
            <p className="font-inter text-[24px] font-bold cursor-pointer">Our Services</p>
            <p className="font-inter text-[24px] font-bold cursor-pointer ">Our Products</p>
            <p className="font-inter text-[24px] font-bold cursor-pointer">Gallery</p>
            <p className="font-inter text-[24px] font-bold cursor-pointer">Contact us</p>
          </div>
         </div>
      ...
      <nav class="relative w-screen h-[104px] shrink-0 flex">
        ...
        <div className="hidden md:flex justify-center items-center absolute right-0 w-[70vw] h-[104px] fill-[#0E1031] bg-[url('https://expertbuildcare.in/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fnav.6a96b04a.png&w=1080&q=75')] bg-no-repeat bg-cover">
          <div className="flex items-center justify-center gap-[0px] xl:gap-[45px] absolute right-[8px] xl:right-[35px] top-[19px]">
            <ul className="flex w-[360px] xl:w-[453px] 2xl:w-[653] items-center gap-[8px] xl:gap-[23px] 2xl:gap-[23px] text-white font-bold text-[16px] 2xl:text-[18px] xl:text-[16px]">
              <li className="cursor-pointer border-t-[2px] border-[#6AAF2E]">Home</li>
              <li className="cursor-pointer">About US</li>
              <li className="cursor-pointer">Services</li>
              <li className="cursor-pointer">Products</li>
              <li className="cursor-pointer">Gallery</li>
            </ul>
            <div className="cursor-pointer flex items-center justify-center h-[61px] px-[11px] py-[3px] xl:px-[31px] xl:py-[23px]  xl:gap-[45px] bg-[#6AAF2E]">
